var PointTools = /** @class */ (function () {
     ...
     *
     */
    PointTools.interpolate = function (startPt, endPt, position) {
     ...
     *
     */
    PointTools.distance = function (p1, p2) {
     ...
     *
     */
    PointTools.distanceByAxis = function (x1, y1, x2, y2) {
     ...
     *
     */
    PointTools.getDirection = function (p1, p2) {
        if (p1.x <= p2.x) {
            return 1;
        }
        if (p1.x > p2.x) {
     ...
     *
     */
    PointTools.localToGlobal = function (target, moveRightNow) {
     ...
     *
     */
    PointTools.parentToParent = function (target, newParent, moveRightNow) {
        var pt = PointTools.localToGlobal(target);
...
//# sourceMappingURL=PointTools.js.map