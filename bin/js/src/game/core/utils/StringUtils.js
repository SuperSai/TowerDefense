...
var StringUtils = /** @class */ (function () {
     ...
     *
     */
    StringUtils.splitStringToArr = function (source_str, lv1_str, lv2_str, lv3_str) {
     ...
     *
     */
    StringUtils.splitStringToKV = function (source_str, lv1_str, lv2_str) {
        if (lv1_str === void 0) { lv1_str = "|"; }
    ...
    /** 将字符串拆分到数组中，数组的每个元素均为键值对象，仅支持含二级或以下分隔符的字符串 */
    StringUtils.splitStringToPoint = function (source_str, separator) {
        if (separator === void 0) { separator = ","; }
        var result = new Laya.Point();
        if (source_str) {
            var arr = StringUtils.splitStringToArr(source_str, separator);
    ...
    StringUtils.wrapValueObjects = function (keys, values) {
        var result = "{";
    ...
    // prettier-ignore
    StringUtils.toTimeShort = function (date, separator) {
        if (separator === void 0) { separator = ":"; }
        var result = "";
     ...
     */
    // prettier-ignore
    StringUtils.toTimeShortWithSec = function (seconds, separator, showLevel) {
        if (separator === void 0) { separator = ":"; }
    ...
    StringUtils.toTimeShortWithMinute = function (seconds, separator) {
        if (separator === void 0) { separator = ":"; }
        var result = "";
    ...
    /** 将给定的数值输出成按千位符分隔的 */
    // prettier-ignore
    StringUtils.toCurrencyString = function (value, separator) {
        if (separator === void 0) { separator = ","; }
    ...
    // prettier-ignore
    StringUtils.toShortCurrencyString = function (value, radix, units) {
    ...
    StringUtils.toUrlQueryString = function (data) {
        var result = "";
    ...
    StringUtils.omitStringByCharLen = function (str, len, omitSymbol) {
        if (len === void 0) { len = 7; }
     ...
     */
    StringUtils.omitStringByByteLen = function (str, len, omitSymbol) {
