var AlignUtils = /** @class */ (function () {
     ...
     *
     */
    AlignUtils.setToScreenCenter = function (sprite, delayFrames, useRegisterPoint) {
        if (delayFrames) {
     ...
     *
     */
    AlignUtils.setToScreenGoldenPos = function (sprite, delayFrames, useRegisterPoint) {
        if (delayFrames) {
     ...
     *
     */
    AlignUtils.setToSpriteCenter = function (target, ref) {
        if (!target || !ref) {
     ...
     *
     */
    AlignUtils.setTo = function (align, target, ref) {
