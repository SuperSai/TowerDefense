...
var OfflineRewardsView = /** @class */ (function (_super) {
    ...
    OfflineRewardsView.prototype.init = function () {
        ...
        self.txtMoney.text = "金币+" + CommonFun.bytesToSize(self._data[0]);
        self.addEvents();
    };
    ...
    OfflineRewardsView.prototype.onVideoHandler = function () {
        ...
        userData.toShareAd(function () {
            self.txtMoney.text = "金币+" + CommonFun.bytesToSize(self._data[0] * 2);
            ...
            CommonFun.showTip("获得金币:" + CommonFun.bytesToSize(self._data[0] * 2));
        }, 1);
    };
    OfflineRewardsView.prototype.onCloseHandler = function () {
        ...
        if (self.btnVideo.visible) {
            LayerManager.getInstance().screenEffectLayer.addChild(new CoinFly().play(LayerManager.mouseX, LayerManager.mouseY));
            CommonFun.showTip("获得金币:" + CommonFun.bytesToSize(self._data[0]));
        }
        self.removeSelf();
        self.removeEvents();
    };
    return OfflineRewardsView;
}(ui.OfflineRewardsViewUI));
