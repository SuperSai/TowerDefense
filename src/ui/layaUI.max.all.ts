...
module ui.evolution {
    export class EvolutionAdvancedViewUI extends View {
		public mainView:View;
		public txtItemPrize5:Laya.Label;
		public txtItemPrize4:Laya.Label;
