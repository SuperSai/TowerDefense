...
module ui.common.view {
    export class MessageTipsUI extends View {
        ...
        public static  uiView:any ={"type":"View","props":{},"child":[{"type":"Image","props":{"y":0,"var":"bg","skin":"images/component/frame_tips_bg.png","sizeGrid":"34,62,36,71"}},{"type":"Image","props":{"y":18,"x":12,"skin":"images/core/core_tips_icon.png"}},{"type":"Label","props":{"y":20,"x":50,"var":"txt_content","text":"消息提示","fontSize":30,"color":"#ffffff","bold":true,"align":"left"}}]};
        constructor(){ super()}
        createChildren():void {
...
module ui.hall {
    export class HallSceneUI extends View {
		...
		public btnInvitation:Laya.Button;
