class MoreController extends Laya.EventDispatcher {
    ...
    public get noQuestMarket():boolean{
        return this._noQuestMarket;
    }

    /** 本次登录后是否曾经打开 */
    public get openedOnce():boolean{
    ...
    private _noQuestMarket:boolean;
    private _openedOnce:boolean;
    ...
    public show(): void {
        if (this._view) {
            ...
            if(this._noQuestMarket){
                ...
                xiaoduo.wxQuestMarket.requestQuestList({success:(list:WXQuestMarketQuest[])=>{
    ...
    private _noQuestMarketNavi():void{
        const list = [
            {
                appName:"宝石俄罗斯方块",
            ...
            },
            {
                ...
                pageQuery:"/pages/index/index",  // @FREEMAN: 跟运营确认过，不需要传页参
